<template>
  <div>
    <el-dialog v-if="dialogVisible" :visible.sync="dialogVisible" width="602px" :show-close="false" class="check-classify" :close-on-press-escape="false" :before-close="beforeClose">
    ...
    <!-- 新增工具弹框 -->
    <AddLoad :addLoadVisible.sync="addLoadVisible" @addSuccess="addSuccess" :forms="form"></AddLoad>
    <!-- 工具执行状态动画 -->
