...
<template>
  <div class="load-manage">
    ...
    <!-- 查看工具分类弹框 -->
    <Classify :dialogDatas="dialogData" :dialogVisible.sync="dialogVisible" @refreshLoad="refreshLoad"></Classify>
    <!-- 新增分类弹框 -->
    <el-dialog :visible.sync="addVisible" width="300px" :show-close="false" class="addfirm" :close-on-click-modal="false"  :close-on-press-escape="false">
      <div class="add-box">
        ...
        <div class="btns">
          ...
          <el-button type="primary" @click="addClassify(classifyName, 'create')">确认</el-button>
        </div>
      </div>
    </el-dialog>
  </div>
